...
const Contact = () => {
	return (
		<div className="card mx-5 h-[65%] mt-5 flex flex-row items-center justify-stretch rounded-xl">
			<iframe
			...
			></iframe>
			<div className="mx-5 p-5 flex flex-col h-[30rem] items-start justify-between">
				<div>
